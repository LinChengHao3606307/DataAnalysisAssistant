...
const chatSubmitBtn = document.getElementById("submitUserInputBtn");

chatUserInput.style.height = 'auto';
chatSubmitBtn.style.height = (chatUserInput.scrollHeight) + 'px';

chatUserInput.addEventListener('input', function() {
    this.style.height = 'auto';
    this.style.height = (this.scrollHeight) + 'px';
    chatSubmitBtn.style.height = 'auto';
    chatSubmitBtn.style.height = (this.scrollHeight) + 'px';
});
...
// WebSocket error handling - 将在HTML中设置